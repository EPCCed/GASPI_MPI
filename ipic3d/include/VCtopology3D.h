...
public:
  ...
  int getXleftYleft_neighbor()const{ return (xleftyleft_neighbor); }
  int getXleftYright_neighbor()const{ return (xleftyright_neighbor); }
  int getXrightYleft_neighbor()const{ return (xrightyleft_neighbor); }
  int getXrightYright_neighbor()const{ return (xrightyright_neighbor); }
