...
__targetHost__ int lb_halo_via_copy_nonblocking_start_GASPI(lb_t * lb);
__targetHost__ int lb_halo_via_copy_nonblocking_end_GASPI(lb_t * lb);

__targetHost__ void halo_planes(lb_t * lb);
__targetHost__ void halo_planes_GASPI(lb_t * lb);
__targetHost__ void halo_edges(lb_t * lb);
__targetHost__ void halo_edges_GASPI(lb_t * lb);
__targetHost__ void halo_corners(lb_t * lb);
__targetHost__ void halo_corners_GASPI(lb_t * lb);
__targetHost__ void unpack_halo_buffers(lb_t * lb);
__targetHost__ void unpack_halo_buffers_GASPI(lb_t * lb);
