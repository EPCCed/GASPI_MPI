...
struct halo_s {
  ...
  MPI_Request sendreqP[6];
  MPI_Request recvreqP[6];
  MPI_Status statusP[12];
  
  MPI_Request sendreqP2[5];
  MPI_Request recvreqP2[5];
  MPI_Status statusP2[10];
  
  
  MPI_Request sendreqE[12];
  MPI_Request recvreqE[12];
  MPI_Status statusE[24];

  MPI_Request sendreqC[8];
  MPI_Request recvreqC[8];
  MPI_Status statusC[16];
};
